                                    ...
                                    <?php foreach ($SubMenu as $sm) :  ?>
                                        <tr>
                                            ...
                                            <button href="#" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit"
                                                ...
                                                <button onclick="deleteSubmenu('<?= base_url('menu/deletee/') . $sm['id'] ?>')" class="btn btn-danger btn-sm tombol-hapus" >Delete</button>
                                            </td>
                                        </tr>
                                        <?php $i++ ?>
                                        <?php endforeach; ?>
...
<div class="modal fade" id="exampleModalsubedit<?= $sm['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabelsubedit" aria-hidden="true">
    <div class="modal-dialog" role="document">
         <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalsubedit">Edit Sub Menu</h5>
            ...
            <form action="<?= base_url('menu/submenuedit'); ?>" method="post">
                ...
                <div class="form-group">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="is_active" name="is_active"
                         class="form_check_label" for="is_active">
                         Active?
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" dara-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary">Add</button>
                </div>
            </form>
        </div>
